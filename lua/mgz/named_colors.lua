...
local mgz = {
	...
	light_gray_bright = "#f33333", -- out of palette, line numbers
	...
	glacier = "#658595", -- mgz9 in palette, comment, lualine outer (normal mode), WHOLE BUNCHA SHIT - #658595
	blue = "#8edfff", -- mgz10 in palette, object fields
	red = "#ff3333", -- mgz11 in palette, lsp errors - #ff3854
	orange = "#00ff00", -- mgz12 in palette
	yellow = "#ffff00", -- mgz13 in palette, !DOCTYPE html, TODO color
