...
local light_colors = {
	mgz0_gui = named_colors.white, -- mgz0 in palette
	mgz1_gui = named_colors.darker_white, -- mgz1 in palette
	mgz2_gui = named_colors.darkest_white, -- mgz2 in palette
	mgz3_gui = named_colors.light_gray, -- mgz3 in palette
	mgz3_gui_bright = named_colors.light_gray_bright, -- out of palette
	mgz4_gui = named_colors.gray, -- mgz4 in palette
	mgz5_gui = named_colors.dark_gray, -- mgz5 in palette
	mgz6_gui = named_colors.black, -- mgz6 in palette
...
local mgz = (vim.o.background == "dark") and dark_colors or light_colors
